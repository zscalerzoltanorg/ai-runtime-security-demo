...
def _traffic_config_from_payload(payload: dict | None) -> dict[str, object]:
    ...
    return {
        ...
        "attachment_rate": _coerce_float(payload.get("attachment_rate"), float(defaults["attachment_rate"]), min_value=0.0, max_value=1.0),
    ...
    <script>
      ...
      const DEMO_WIZARD_RECIPES = {{
        ...
        guard_api: {{
          ...
          proxy: false,
          dasMode: "resolve",
          prompt: "This message contains a generic secret marker: DEMO-SECRET-REDACTED"
        }},
        guard_proxy: {{
    ...
    },
    {
        ...
        "presets": [
            ...
            },
            {
                ...
                "prompt": "I found this generic secret marker in logs: DEMO-SECRET-REDACTED. Is it sensitive?",
            },
            {
